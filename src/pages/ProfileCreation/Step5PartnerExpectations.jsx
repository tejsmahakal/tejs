...
const Step5PartnerExpectations = ({
  ...
  const { 
    ...
    isSuccess,
    refetch 
  } = useGetPartnerPreferenceQuery(undefined, {
  ...
  useEffect(() => {
    ...
    console.log("Partner API Response:", apiData);
    
    const partnerData = apiData;
  ...
  const handleNextClick = async () => {
    ...
    try {
      ...
      if (response && (response.success !== false || response.statusCode === 200 || response.statusCode === 201)) {
        const successMsg = hasExistingPartner
          ? "Partner preferences updated successfully!"
          : "Partner preferences created successfully!";
        ...
        setErrorMessage(response?.message || "Failed to save partner preferences");
      }
      ...
      <div className="px-4 sm:px-6 md:px-10 py-8" style={{ backgroundColor: "#FF8C4405" }}>
        ...
        <form className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 text-sm text-gray-700">
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Format: min-max (e.g., 25-35)</p>
            {touchedFields.ageRange && validationErrors.ageRange && <p className="text-red-500 text-xs mt-1">{validationErrors.ageRange}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.lookingFor && validationErrors.lookingFor && <p className="text-red-500 text-xs mt-1">{validationErrors.lookingFor}</p>}
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Include units (ft/cm/inch)</p>
            {touchedFields.heightRange && validationErrors.heightRange && <p className="text-red-500 text-xs mt-1">{validationErrors.heightRange}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.partnerComplexion && validationErrors.partnerComplexion && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerComplexion}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.partnerReligion && validationErrors.partnerReligion && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerReligion}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              maxLength={50}
            />
            {touchedFields.partnerCaste && validationErrors.partnerCaste && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerCaste}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              maxLength={50}
            />
            {touchedFields.partnerSubCaste && validationErrors.partnerSubCaste && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerSubCaste}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              maxLength={100}
            />
            {touchedFields.partnerEducation && validationErrors.partnerEducation && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerEducation}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.residentStatus && validationErrors.residentStatus && <p className="text-red-500 text-xs mt-1">{validationErrors.residentStatus}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              maxLength={100}
            />
            {touchedFields.partnerOccupation && validationErrors.partnerOccupation && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerOccupation}</p>}
          </div>
          ...
          <div>
            ...
            />
            <p className="text-xs text-gray-500 mt-1">Annual income (₹1,00,000 - ₹5,00,00,000)</p>
            {touchedFields.partnerIncome && validationErrors.partnerIncome && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerIncome}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.countryLivingIn && validationErrors.countryLivingIn && <p className="text-red-500 text-xs mt-1">{validationErrors.countryLivingIn}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              maxLength={50}
            />
            {touchedFields.cityLivingIn && validationErrors.cityLivingIn && <p className="text-red-500 text-xs mt-1">{validationErrors.cityLivingIn}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              maxLength={50}
            />
            {touchedFields.stateLivingIn && validationErrors.stateLivingIn && <p className="text-red-500 text-xs mt-1">{validationErrors.stateLivingIn}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.eatingHabits && validationErrors.eatingHabits && <p className="text-red-500 text-xs mt-1">{validationErrors.eatingHabits}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.partnerDrinkingHabits && validationErrors.partnerDrinkingHabits && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerDrinkingHabits}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.partnerSmokingHabits && validationErrors.partnerSmokingHabits && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerSmokingHabits}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.mangal && validationErrors.mangal && <p className="text-red-500 text-xs mt-1">{validationErrors.mangal}</p>}
          </div>
          ...
          <div>
            ...
            {touchedFields.partnerMaritalStatus && validationErrors.partnerMaritalStatus && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerMaritalStatus}</p>}
          </div>
          ...
          <div>
            ...
            <input
              ...
              maxLength={50}
            />
            {touchedFields.partnerMotherTongue && validationErrors.partnerMotherTongue && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerMotherTongue}</p>}
          </div>
          ...
          <div className="sm:col-span-2 md:col-span-3 lg:col-span-4">
            ...
            <textarea
              ...
              placeholder="Any other preferences (optional)"
              className="w-full px-3 py-2 focus:ring-1 focus:ring-orange-400 outline-none"
              style={{ ...getFieldStyle("partnerAdditionalPreferences"), minHeight: "80px" }}
              rows={3}
              maxLength={500}
            />
            {touchedFields.partnerAdditionalPreferences && validationErrors.partnerAdditionalPreferences && <p className="text-red-500 text-xs mt-1">{validationErrors.partnerAdditionalPreferences}</p>}
          </div>
        </form>
      </div>
